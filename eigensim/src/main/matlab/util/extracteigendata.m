...
% It extracts traffic information from provided file and calculates GETV
% for kinds of traffic. It extracts GETV information by different granularities 
function extracteigendata(dataPath, resultPath )
...
for matrix = 1:numberOfMatrices
    ...
    [portMinutes, mapMinutes] = getportfreq([dataPath matrices{matrix} '/traffic/minutes_'], numberOfPorts, ports, 'minutes', portMinutes, mapMinutes);
    ...
    [portSeconds, mapSeconds] = getportfreq([dataPath matrices{matrix} '/traffic/seconds_'], numberOfPorts, ports, 'seconds', portSeconds, mapSeconds);

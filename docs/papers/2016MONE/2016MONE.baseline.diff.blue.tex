...
\author{Tatiana Galibus				\and
        Thiago P. de B. Vieira		\and
        	...
        	Rafael T. de \DIFaddbegin \DIFadd{Sousa }\DIFaddend Júnior	\and
...
\institute{Tatiana Galibus \and Viktor Krasnoproshin \at
           ...
           \and
           Tatiana Galibus \and Thiago P. \DIFaddbegin \DIFadd{de }\DIFaddend B. Vieira \and Robson \DIFaddbegin \DIFadd{de }\DIFaddend O. Albuquerque \and João Paulo C. L da Costa \and Rafael T. de  \DIFaddbegin \DIFadd{Sousa }\DIFaddend Júnior  \at
           ...
           João Paulo C. L da Costa \and Giovanni del Galdo \at
				Institute for Information Technology, Ilmenau University of Technology, Ilmenau, Germany \DIFaddbegin \DIFadd{, and }\DIFaddend Fraunhofer Institute for Integrated Circuits IIS, Erlangen, Germany
           \and
...
From the theoretical point of view of this problem, there are several surveys, whose common point is the mobile cloud as a rapidly developing paradigm that poses many security and complexity problems  \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
...
\DIFaddend An analysis of the new models of mobile cloud computing and new ways of using data storage services is presented in \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{khan2015cloud, khan2013towards, mayrhofer2015architecture, chang2015design}
}%DIFAUXCMD
}\DIFaddend . Commonly, the models and protection schemes concentrate on the encryption properties and either perform the computations on their own \cite{zhao2010trusted, yang2011provable} or use the cloud provider to off-load the cryptographic operations \cite{itani2010energy, ren2011lightweight}. Obviously, it is natural the mobile client cannot handle all operations securely without the assistance of a cloud provider, due to resources constraint and battery limitation.

The necessity to use schemes that function without putting load on a provider arises when it is desired to make the mobile client less dependent on the cloud provider, i.e. corporate client continues to provide the secure access to the sensitive data without connection to the network. As discussed in \cite{khan2015cloud}, all the currently known schemes of encryption, performing the computation, either use a cloud provider \cite{zhao2010trusted}, a third party trusted agent \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
...
}\DIFaddend . In some cases, they concentrate on computational complexity without taking care of user privacy and security \cite{ren2011lightweight}. Therefore, according to \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
...
The authors thank the Brazilian research and innovation agencies \DIFaddbegin \DIFadd{CAPES (Grant FORTE }\\\DIFadd{23038.007604/2014-69), }\DIFaddend FAPDF (Research Support Foundation of the Federal District), FINEP (\DIFaddbegin \DIFadd{Grant RENASIC }\DIFaddend PROTO 01.12.0555.00), \DIFaddbegin \DIFadd{CNPq (Productivity grant }\DIFaddend 303905/2014-0 \DIFaddbegin \DIFadd{and PVE Grant }\DIFaddend 88881.030392/2013-01 \DIFaddbegin \DIFadd{), as well as the European CSF - Aerospace Technology Program (PDE scholarship within project }\DIFaddend 207644/2015-2 \DIFaddbegin \DIFadd{), for their support to this research}\DIFaddend .\end{acknowledgements}

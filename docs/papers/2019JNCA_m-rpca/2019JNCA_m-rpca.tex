...
Khattak \emph{et al} \cite{khattak2015botflex} proposed BotFlex, which is a network-based tool for botnet detection, based on a decision module as a Complex Event Processing (CEP) engine and based on a correlation framework that continuously receives events from the sensor module and correlates them according to rule(s). 

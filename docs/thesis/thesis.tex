...
\date{2017-06-30} %data da defesa

\grau{Ph.D} %Mestre ou Doutor
\area{Eletrical Engennering} %Nome do curso
\siglaarea{ENE} %Sigla do departamento
\tipodemonografia{Thesis} %Dissertação ou Tese
\programa{Mestrado} %Mestrado ou Doutorado
\autorendereco{THIAGO PEREIRA DE BRITO VIEIRA.} %Endereço do autor da dissertação/tese
...
\titulolinhai{DISCRIMINATIVE SENSING}
\titulolinhaii{BASED ON SIGNAL PROCESSING}
\titulolinhaiv{}

...
This architecture consists of the modules of cryptographic functions, threat intelligence infrastructure, communication with server and storage. This work focus on the threat intelligence infrastructure module.
...
The communication with server includes the separate sender and receiver to check the user credentials and receive new keys. The remaining data like access list and files can be sent via unprotected channels. 
...
This section provides the detailed analysis of the results fro the proposed approach regarding security and complexity analysis.

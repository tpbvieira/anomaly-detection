...
dataset_path = os.path.join('/media/thiago/ubuntu/datasets/network/','stratosphere-botnet-2011/CTU-13-Dataset/')
directory = os.fsencode(dataset_path)

files = os.listdir(directory)

# The datastructure to hold our feature extraction functions, which will get applied to each aggregation of the datasets.
extractors = {

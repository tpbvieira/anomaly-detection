...
# feature_result_file = '/home/thiago/dev/anomaly-detection/network-attack-detection/moment-rpca/clean.csv'
# if os.path.isfile(feature_result_file):
#     result_df = pd.read_csv(feature_result_file, sep='\t')
#     mean_list = result_df.groupby('window')['location_contamination'].max()
#     print(mean_list.sort_values(ascending=False))
#     print(mean_list.mean())
#     mean_list = result_df.groupby('window')['skewness_contamination'].max()
#     print(mean_list.sort_values(ascending=False))
#     print(mean_list.mean())
#     mean_list = result_df.groupby('window')['kurtosis_contamination'].max()
#     print(mean_list.sort_values(ascending=False))
#     print(mean_list.mean())

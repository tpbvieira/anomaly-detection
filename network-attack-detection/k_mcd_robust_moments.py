...
def _c_step(X, n_support, random_state, remaining_iterations=30, initial_estimates=None, verbose=False, cov_computation_method=empirical_covariance):
    ...
    skew2 = skew(X_support, axis=0, bias=False)
    kurt1 = kurtosis(X_support, axis=0, fisher=True, bias=True)
    kurt2 = kurtosis(X_support, axis=0, fisher=False, bias=True)
    moment2 = moment(X_support, moment=2, axis=0)
    moment3 = moment(X_support, moment=3, axis=0)
    moment4 = moment(X_support, moment=4, axis=0)
    moment5 = moment(X_support, moment=5, axis=0)
    moment6 = moment(X_support, moment=6, axis=0)
...
def select_candidates(X, n_support, n_trials, select=1, n_iter=30, verbose=False, cov_computation_method=empirical_covariance, random_state=None):
    ...
    best_kurt2 = np.asarray(all_kurt2_sub)[index_best]
    best_moment2 = np.asarray(all_moment2_sub)[index_best]
    best_moment3 = np.asarray(all_moment3_sub)[index_best]
...
class MMinCovDet(EmpiricalCovariance):
    ...
    def fit(self, X, y=None):
        ...
        self.raw_kurt2_ = raw_kurt2
        self.raw_moment2_ = raw_moment2
        self.raw_moment3_ = raw_moment3

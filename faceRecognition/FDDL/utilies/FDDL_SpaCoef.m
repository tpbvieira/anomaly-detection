...
[gap] = FDDL_Class_Energy(Ai,D,xm1,Xa,drls,trls,index,lambda1,lambda2,lambda3,lambda4,classn,fish_tau2,fish_tau3);
prev_f = gap;
ert(1) = gap;
for n_it = 2 : nIter;
    ...
    while for_ever
        ...
        grad = FDDL_Gradient_Comp(xm1,Xa,classn,index,lambda2,lambda3,lambda4,fish_tau2,fish_tau3,trls,drls,newpar,BAI,CJ);
        ...
        if (IST_iters >= 2) | ( TwIST_iters ~= 0)
            ...
            % compute residual
            [gap] = FDDL_Class_Energy(Ai,D,xm2,Xa,drls,trls,index,lambda1,lambda2,lambda3,lambda4,classn,fish_tau2,fish_tau3);
            ...
            [gap] = FDDL_Class_Energy(Ai,D,x_temp,Xa,drls,trls,index,lambda1,lambda2,lambda3,lambda4,classn,fish_tau2,fish_tau3);

...
public class NslKdd {
	...
	public static void main(String[] args) { 
		...
		String filePath = "/home/thiago/tmp/OriginalNSLKDDZip";
		...
		HashMap<Long,HashMap<String,Integer>> values = StoregridCase.parseCSV(filePath, sdf, matrixRowIndeces);
		...
		Matrix[] matrices = StoregridCase.modelIntoMatrices(windowSize, matrixRowIndeces, values, matrixColumnIndeces);
		endTime = System.currentTimeMillis();

...
filePath = '/media/thiago/ubuntu/datasets/imageDenoising/gray_192_512/';              % change to save generated data
noisyFilePath = sprintf('%snoisyPatches.csv', filePath);                    % noisy data
X = dlmread(noisyFilePath);
X = X.';
L = size(X, 2);                                                                  % number of observations
...
fprintf('## Image Denoising based on Dictionary Learning');
